...
async def main():
    ...
    with tempfile.TemporaryDirectory(prefix="hermes-companion-smoke-") as tempdir:
        ...
        config = {
            ...
            "centralName": "Smoke Hermes",
            "registrationUrl": f"http://127.0.0.1:{http_port}/register-node",
            "chatHttpUrl": "",
            "chatWsUrl": "",
            "statusWsUrl": f"ws://127.0.0.1:{ws_port}",
            "heartbeatUrl": f"http://127.0.0.1:{http_port}/heartbeat",
            "apiToken": "",
            "chatModel": "gpt-4.1-mini",
            "nodeName": "smoke-node",
            "centralSshPublicKey": "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIKhermescentraltestkey hermes-central",
            "sshAuthorizedUser": os.environ.get("USER") or os.environ.get("USERNAME") or "unknown",
